...
//      hypotenuse -= 65;
    ...
    public LineItem rafters(int carportWidth, int carportLength, Shed shed) throws NoSuchMaterialException {
    ...
    public LineItem fasciaCarport(int carportLength, Shed shed) throws NoSuchMaterialException {
