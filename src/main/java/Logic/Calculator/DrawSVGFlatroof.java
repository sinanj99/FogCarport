...
public class DrawSVGFlatroof {
    ...
    public String drawFlat(Carport c) {
        ...
        //STOLPER 
        float spaceBetweenSpærVAR = f.spaceBetweenSpær(c, 60);
        ...
        //SPÆR
        int quantityOfSpær = f.calculateQuantityOFSpærExcluedBackSpær(c, 60);
        int quantityOfSpærPlusTheBackSpær = f.calculateQuantityOfSpærIncludedBackSpær(c, 60);
        ...
        //DIMENSION mål
            ...
            for(int i = 0; i < f.calculateQuantityOFSpærExcluedBackSpær(c, 60); i++)
            {
                drawing += "<line x1='"+startPointThis+"' y1='"+40+
                "' x2='"+(startPointThis + f.spaceBetweenSpær(c, 60) - 6)+"' y2='"+  40 +
                ...
                drawing += "<text x='"+(startPointThis + 2)+"' y='"+35+ "' fill='black' font-size='12px'>"
                    +f.spaceBetweenSpær(c, 60)+" cm</text>";
                
                startPointThis += f.spaceBetweenSpær(c, 60) + 3;
            }
