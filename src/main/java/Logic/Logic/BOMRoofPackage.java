...
public class BOMRoofPackage {
     ...
     */
    protected double calculateHypotenuseForRoof(Carport c) {
     ...
     */
    protected int amountOfScrewsLathHolders(Carport c) {
     ...
     */
    protected int amountOfScrewsLaths(Carport c) {
     ...
     */
    protected LineItem screwsLathHolders(Carport c) throws SystemErrorException, NoSuchMaterialException {
     ...
     * @throws NoSuchMaterialException if no materials with specified id exist
     */
    protected LineItem LathScrews(Carport c) throws SystemErrorException, NoSuchMaterialException {
    ...
    /**
     * Calculates the amount of laths needed. Protected since it is called in
     * draw svg
     *
     * @param c the carport
     * @return amount of alths needed
     */
    protected int amountOfLaths(Carport c) {
...
//        /*the hypotenuse is now used to calculate the amount of laths*/
     ...
     */
    protected int amountOfSoffits(Carport c) {
        int triangleWidth = c.getWidth() / 2; // width of each triangle.
        double inclination = Math.toRadians(c.getInclination()); //Math.cos expects radians
        double hypotenuse = triangleWidth / Math.cos(inclination);
        if (hypotenuse * 2 <= 240) {
     ...
     * @throws NoSuchMaterialException if no materials with specified id exist
     */
    protected LineItem laths(Carport c) throws NoSuchMaterialException, SystemErrorException {
     ...
     * @throws NoSuchMaterialException if no materials with specified id exist
     */
    protected LineItem toplaths(Carport c) throws NoSuchMaterialException, SystemErrorException {
     ...
     * @throws NoSuchMaterialException if no materials with specified id exist
     */
    protected LineItem soffits(Carport c) throws NoSuchMaterialException, SystemErrorException {
     ...
     */
    protected int amountOfLathHolders(Carport c) {
     ...
     */
    protected int amountOfRoofTiles(Carport c) {
 ...
 /*the answer can be calculated by dividing the square meter measurement of the roof (hypotenuse * carportlength)
     ...
     * @return (rygsten)
     */
    protected int amountOfRidgeTiles(Carport c) {
        /*
     ...
     */
    protected int amountOfRidgeTileBrackets(Carport c) {
     ...
     * @throws NoSuchMaterialException if no materials with specified id exist
     */
    protected LineItem lathHolders(Carport c) throws SystemErrorException, NoSuchMaterialException {
     ...
     * @param c the carport
     * @return a LineItem object of laths
     * @throws Presentation.Exceptions.NoSuchRoofException if a roof with the
     * specified id is not found
     */
    protected LineItem roofTiles(Carport c) throws NoSuchRoofException, SystemErrorException {
     ...
     *
     * @return a LineItem object of laths
     * @throws NoSuchMaterialException if no materials with specified id can be
     * found
     * @throws SystemErrorException an sql-exception is thrown
     */
    protected LineItem roofTileBinders() throws SystemErrorException, NoSuchMaterialException {
     ...
     */
    protected LineItem ridgeTiles(Carport c) throws SystemErrorException {
     ...
     * @throws SystemErrorException an sql-exception is thrown
     */
    protected LineItem ridgeTileBrackets(Carport c) throws SystemErrorException, NoSuchMaterialException {
