...
<body onload="spaceForShed(); checkAll()" class="background2">
    <div class="container">
        <form onkeyup="checkAll()" onchange="checkAll()" class="standarddiv pl-0 pr-0 d-flex flex-column justify-content-center" method="post" action="FrontController">
    ...
    <script src="/project/include/javascriptrequestincline.js"></script>
